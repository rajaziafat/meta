...
function FAQ() {
    ...
    return (
        ...
        <h1 className="lg:text-[60px] md:text-[52px] sm:text-[40px] text-[32px] font-black mt-20">GENERAL <span className="text-[#FFFA7E]">FAQS</span></h1>
        <p className="md:pr-5 pr-0 mt-4 flex flex-col lg:items-start items-center lg:w-[60%] md:w-[80%] sm:w-[90%] w-[100%]">As a MetaEstate construction service provider,<br className='sm:flex hidden'/> MetaEstate selects renowned Metaverse platforms to participate in parcel transactions, construction, etc.</p>
        <button className="mt-6 w-[124px] h-[48px] btn2 text-[12px] font-black lg:flex items-center justify-center hidden" style={{border:"none",outline:"none",borderRadius:"50px"}}>CONTACT US</button>
            ...
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a class="text-white text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">+</a>
                </div>
                )}
                {check===1 &&(
                    <div className='w-5 h-5 rounded-full bg-[#FFFA7E] text-black flex justify-center items-center' onClick={handleClose}>
                <a class="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample" role="button" aria-expanded="false" aria-controls="collapseExample">-</a>
                    </div>
                )}
                    </div>
            ...
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a class="text-white text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample">+</a>
                </div>
                )}
                {checks===1 &&(
                    <div className='w-5 h-5 rounded-full bg-[#FFFA7E] text-black flex justify-center items-center' onClick={handleClose1}>
                <a class="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample1" role="button" aria-expanded="false" aria-controls="collapseExample">-</a>
                    </div>
                )}
                    </div>
            ...
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a class="text-white text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">+</a>
                </div>
                )}
                {checkss===1 &&(
                    <div className='w-5 h-5 rounded-full bg-[#FFFA7E] text-black flex justify-center items-center' onClick={handleClose2}>
                <a class="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample2" role="button" aria-expanded="false" aria-controls="collapseExample">-</a>
                    </div>
                )}
                    </div>
            ...
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a class="text-white text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">+</a>
                </div>
                )}
                {checksss===1 &&(
                    <div className='w-5 h-5 rounded-full bg-[#FFFA7E] text-black flex justify-center items-center' onClick={handleClose3}>
                <a class="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample3" role="button" aria-expanded="false" aria-controls="collapseExample">-</a>
                    </div>
                )}
                    </div>
            ...
            <div className='flex justify-between items-center px-3 py-3'>
                ...
                <a class="text-white text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample">+</a>
                </div>
                )}
                {checkssss===1 &&(
                    <div className='w-5 h-5 rounded-full bg-[#FFFA7E] text-black flex justify-center items-center' onClick={handleClose4}>
                <a class="text-[18px] flex justify-center items-center" data-toggle="collapse" href="#collapseExample4" role="button" aria-expanded="false" aria-controls="collapseExample">-</a>
                    </div>
                )}
                    </div>
